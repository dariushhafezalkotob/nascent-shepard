...
export const FURNITURE_TEMPLATES: FurnitureTemplate[] = [
    // Living Room
    { id: 'sofa', label: 'Sofa', category: 'living', width: 2.1, depth: 0.95, budgetWeight: 4.0 },
    ...
    { id: 'coffee-table-square', label: 'Square Coffee Table', category: 'living', width: 0.9, depth: 0.9, budgetWeight: 1.2 },
    { id: 'coffee-table-round', label: 'Round Coffee Table', category: 'living', width: 0.8, depth: 0.8, budgetWeight: 1.2 },

    // Bedroom
    { id: 'bed', label: 'Bed', category: 'bedroom', width: 1.6, depth: 2.1, budgetWeight: 4.5 },
    ...
    // Kitchen
    { id: 'kitchen-base', label: 'Base Cabinet', category: 'kitchen', width: 0.6, depth: 0.56, budgetWeight: 1.5 },
    { id: 'kitchen-wall', label: 'Wall Cabinet', category: 'kitchen', width: 0.6, depth: 0.35, budgetWeight: 1.2 },
